...
IPAddress apIP(192, 168, 4, 1);    // if you want to configure another IP address
void setup()
{
  // setup globals
  ulReqcount = 0;
...
void webserver() {   /// complete web server (same for access point) ////////////////////////////////////////////////////////
  ...
  else
  {
    ...
    sResponse += "<script src='https://code.jquery.com/jquery-3.3.1.js'></script>";
