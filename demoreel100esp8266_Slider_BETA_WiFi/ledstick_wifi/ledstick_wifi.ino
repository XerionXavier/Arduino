...
void webserver() {   /// complete web server (same for access point) ////////////////////////////////////////////////////////
  ...
  {
    ulReqcount++;
    sResponse  = "<html><head><title>LED Me 1.0</title>";
    ...
    //sResponse += "<nav class=\"navbar navbar-default\">";
    //sResponse += "<div class=\"navbar-header\">";
    sResponse += "<div class=\"container\">";
    //sResponse += "<div class=\"jumbotron\">";
    sResponse += "<h1 class=\"text-muted\">Joule</h1><br>";
    ...
    */
    ...
    sResponse += "<div class=\"form-group col-md-3\">";
    //sResponse += "<label for=\"styles\">Select Animation:</label>";
